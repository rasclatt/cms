...
<a href="#" class="sidebar nTrigger<?php if($this->getGet('loadpage') == 'load_settings_page' && $this->getGet('subaction') == 'plugins') echo ' nListener' ?>" data-instructions='{"DOM":{"sendto":["#admin-content"],"html":["<img src=\"/core/template/default/media/images/ui/loader.gif\" class=\"loader\" />"],"event":["click"]},"action":"load_settings_page","data":{"deliver":{"subaction":"plugins"}}}'>Widgets</a>
