...
?>
		<div class="component-editor-toggle" id="component-<?php echo $compData['ID'] ?>-toggler">
			...
			<div style="z-index: -1; <?php if(!empty($compData['file_path'])): ?>background-image: url('<?php echo $this->getThumbnail($compData['file_path'], $compData['file_name']) ?>'); <?php endif ?>" data-instructions='{"action":"nbr_load_component","data":{"deliver":{"ID":"<?php echo $ID ?>"}}}'>
