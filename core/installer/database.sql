...
--
-- Host: 10.30.84.154:3306
-- Generation Time: Nov 12, 2018 at 09:39 PM
...
(66, '2016120214231458412266', '', '/AdminTools/', 'Nubersoft', NULL, '', 'admintools', '/core/template/default/', '', 'off', 'off', 1, '', 'off', 'on', 'NBR_ADMIN', 'on', 1),
(67, '201612021444165841104219', '', '/', 'Home Page', NULL, '', 'home', '/core/template/default/', '', 'off', 'on', 2, '', 'off', 'off', '0', 'on', 1),
(70, '20171226130020542864427', '', '/contact-us/', 'Contact', NULL, '', 'contact-us', '/core/template/default/', '', 'off', 'on', 0, '', 'off', 'off', 'NBR_WEB', 'on', 2),
(71, '2018012313245356782531', '', '/login/', 'Login', NULL, '', 'login', '/core/template/default/', '', 'off', 'on', 3, '/', 'on', 'on', 'NBR_WEB', 'on', 1),
(75, '20181106110902768054', '', '/my-account/', 'Account', NULL, NULL, 'my-account', '/core/template/default/', '', 'off', 'on', 0, '', 'off', 'on', 'NBR_WEB', 'on', 4);
...
--
ALTER TABLE `members_connected`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24695;
--
-- AUTO_INCREMENT for table `system_settings`
--
ALTER TABLE `system_settings`
  MODIFY `ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=669;
--
