function initCart(CartEngine, cartSettings)
{
    let doc = $(document);
     ...
     */
    doc.on('click', '.clear-cart', function(e){
     ...
     */
    doc.on('submit', '.cart-add',  function(e){
     ...
     */
    doc.on('click', '.addtocart,.clearitem,.removefromcart,.cart-activator', function(e){
